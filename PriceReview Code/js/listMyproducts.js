...
let productUrl = './src/listmyproducts.php';
let editReviewtUrl = './src/editReview.php';
   ...
   //console.log(searchItem);
    ...
    try {
        request.onreadystatechange = function () {
            ...
            var readMoreButton = ` <button type="button" class="btn btn-warning mt-4 text-white" data-toggle="modal" data-target="#editReviewModal" onclick="setIndex2(${i});">
                                <i class="icon-cart-add mr-2"></i>Edit review
                            </button> `;
 ...
 if (reviewText(reviewtext))
    {
       ...
       console.log(json1);
        ...
        request1.open("POST", editReviewtUrl, true);
            ...
            request1.onreadystatechange = function()
        {
            ...
            {    
                ...
                if (errormsg === "done")
                    {
                        document.getElementById("errortext").innerHTML = "Thank you.<br> Review Updated successfully";
